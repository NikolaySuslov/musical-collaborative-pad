import { RenkonCyclist } from './renkoncyclist.js';
...
const core = window.StrudelLib.core;
const {errorLogger, logger, setTime, evalScope, register, Pattern, isPattern, silence, stack, reset_state} = core;
const _evaluate = core.evaluate;
...
export function repl({
  ...
  const scheduler =  new RenkonCyclist(schedulerOptions);
  let pPatterns = {};
