...
import { ClockCollator, cycleToSeconds } from './util.js';

const logger = window.StrudelLib.core.logger;

export class RenkonCyclist {
  ...
  setTick(tick){
    this.renkonTick = tick;
    console.log("RenkonCyclist tick set: ", tick);
    if(tick.cps)
